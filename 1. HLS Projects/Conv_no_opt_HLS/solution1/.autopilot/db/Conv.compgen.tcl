...
set id 1
set name Conv_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 2
set name Conv_dmul_64ns_64ns_64_5_max_dsp_1
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_in_V_data'"
}
}
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_out_V_data'"
}
}
